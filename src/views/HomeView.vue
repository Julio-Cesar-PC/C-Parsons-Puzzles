        ...
        <div class="container m-auto px-6 py-12">
          <div
            ...
            <div v-if="userData" class="flex flex-col items-center text-center">
              <img :src="userData.pic" alt="Foto de perfil" class="w-20 h-20 rounded-full shadow-lg mb-4" />
            ...
            <div v-else class="text-center">
              ...
              <p class="text-lg leading-relaxed text-justify">
                A plataforma utiliza <span class="text-primary">Parsons Puzzles</span> para ajudar no
                aprendizado de lógica de programação. <br />
                O objetivo é desembaralhar blocos de código para formar soluções corretas, facilitando o entendimento da
