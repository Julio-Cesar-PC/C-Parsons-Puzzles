...
.v3ti .v3ti-new-tag--error {
  color: #F56C6C;
}`;q(Fe);z.render=Ae;var Le=(()=>{const e=z;return e.install=n=>{n.component("Vue3TagsInput",e)},e})();const De=X({name:"TagsInput",components:{Vue3TagsInput:Le},props:{modelValue:{type:Array,default:()=>[]}},emits:["update:modelValue"],setup(e,{emit:n}){const t=P([...e.modelValue]);return j(()=>e.modelValue,a=>{t.value=[...a]}),{internalTags:t,handleChangeTag:a=>{t.value=a,n("update:modelValue",a)}}}});function Pe(e,n,t,r,a,i){const c=L("vue3-tags-input");return l(),D(c,{class:"bg-base-100 rounded-lg",tags:e.tags,placeholder:"Matemática, Física...",onOnTagsChanged:e.handleChangeTag},null,8,["tags","onOnTagsChanged"])}const He=$(De,[["render",Pe]]),je=`void main() {
  // Your code here
